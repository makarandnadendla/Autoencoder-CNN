...
results_pd.to_csv(os.path.sep.join([args["output"], "cifar10_convautoencoder_minivggnet_classification_report.csv"]))
PlotCm(testY.argmax(axis = 1), predictions.argmax(axis=1), target_names=labelNames, output_path = os.path.sep.join([args["output"], "cifar10_convautoencoder_minivggnet_conf_matrix.png"]))
